...
public class Paddle {
    ...
    Image paddle = new Image(getClass().getResource("/Paddle/n-paddle0.png").toExternalForm(), 200, 40, false, false);
    Image paddle2 = new Image(getClass().getResource("/Paddle/n-paddle1.png").toExternalForm(), 200, 40, false, false);
    Image paddle3 = new Image(getClass().getResource("/Paddle/n-paddle1.png").toExternalForm(), 200, 40, false, false);
