...
public class Block {
    ...
    Image block1 = new Image(getClass().getResource("/Brick/normal brick1.png").toExternalForm(), 100, 35, false, false);
    Image block2 = new Image(getClass().getResource("/Brick/normal brick2.png").toExternalForm(), 100, 35, false, false);
    Image block3 = new Image(getClass().getResource("/Brick/normal brick5.png").toExternalForm(), 100, 35, false, false);
    Image block4 = new Image(getClass().getResource("/Brick/normal brick13.png").toExternalForm(), 100, 35, false, false);
    Image block5 = new Image(getClass().getResource("/Brick/normal brick14.png").toExternalForm(), 100, 35, false, false);

    Image block6 = new Image(getClass().getResource("/Brick/small brick7.png").toExternalForm(), 80, 50, false, false);
    ...
    public Pane create_backgroundForBricks(Pane p) {
        Image backGround = new Image(getClass().getResource("/Background/ww.jpg").toExternalForm(), 1400, 800, false, false);
