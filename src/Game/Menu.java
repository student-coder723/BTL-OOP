...
import Game.MenuDesign.MenuBox;
import Game.MenuDesign.MenuItem;
import Game.MenuDesign.Title;
...
public class Menu
{
    ...
    static Image cursor_img = new Image(Menu.class.getResource("/Images/yellowCursor2.png").toExternalForm(),200,150,false,false);
    static Image cursor_img_hand = new Image(Menu.class.getResource("/Images/hoverCursor2.png").toExternalForm(),200,150,false,false);
    ...
    {
        Image Imageback=new Image(getClass().getResource("/Background/bb.jpg").toExternalForm(),1500,780,false,true);
