...
public class icons {
    ...
    Image img_expand = new Image(getClass().getResource("/Images/Capsule/expand.png").toExternalForm(), 100, 20, false, false);
    Image img_shrink = new Image(getClass().getResource("/Images/Capsule/shrink.png").toExternalForm(), 100, 20, false, false);
    Image img_slow = new Image(getClass().getResource("/Images/Capsule/slow.png").toExternalForm(), 100, 20, false, false);
    Image img_fast = new Image(getClass().getResource("/Images/Capsule/fast.png").toExternalForm(), 100, 20, false, false);
    Image img_empty = new Image(getClass().getResource("/Images/Capsule/empty.png").toExternalForm(), 100, 20, false, false);
    Image img_heart = new Image(getClass().getResource("/Images/Capsule/life.png").toExternalForm(), 35, 35, false, false);
    Image img_shot_gun = new Image(getClass().getResource("/Images/Capsule/laser.png").toExternalForm(), 100, 20, false, false);
    Image img_extra50 = new Image(getClass().getResource("/Images/Capsule/extra50.png").toExternalForm(), 100, 20, false, false);
    Image img_extra100 = new Image(getClass().getResource("/Images/Capsule/extra100.png").toExternalForm(), 100, 20, false, false);
